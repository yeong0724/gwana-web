      ...
      <div className="flex flex-col w-full max-w-[500px] mx-auto flex-1 border-x border-gray-100 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto bg-gray-100 min-h-0">
          {cart.length === 0 ? (
            ...
            <div className="flex flex-col gap-6 sm:gap-5 md:gap-6 p-3 sm:p-4">
              {/* 장바구니 아이템 리스트 */}
              {map(cart, (item, index) => (
                <div
        ...
        {/* 결제 예상 금액 - 고정 영역 */}
        <div className="flex-shrink-0 border-t-2 border-gray-200 bg-white p-3 sm:p-4 z-10">
