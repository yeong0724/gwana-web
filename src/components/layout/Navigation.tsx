...
const Navigation = ({ isMenuOpen, moveToLoginPage, toggleMenu, menuGroup }: Props) => {
  ...
  return (
    <>
      {/* 오버레이 */}
      <div
        className={`navigation-overlay fixed inset-0 bg-gray-800 bg-opacity-5 z-[70] transition-opacity duration-600 ${
      ...
      {/* 사이드바 메뉴 */}
      <div
        className={`navigation-sidebar fixed top-0 left-0 h-full w-[90%] bg-white z-[1000] transform transition-transform duration-600 ease-in-out ${
