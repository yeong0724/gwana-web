        ...
        <article className="space-y-10 text-body text-warm-700 leading-relaxed">
          ...
          <Section title="제3조 (약관 등의 명시와 설명 및 개정)">
            <ol className="list-none space-y-2">
              <Li n="1">
                ...
                주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소,
                사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자 등을 이용자가 쉽게
                알 수 있도록 관아수제차 사이버 몰의 초기 서비스화면(전면)에 게시합니다.
                다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수
                있습니다.
              </Li>
              <Li n="2">
                &ldquo;몰&rdquo;은 이용자가 약관에 동의하기에 앞서 약관에 정하여져
                있는 내용 중 청약철회·배송책임·환불조건 등과 같은 중요한 내용을 이용자가
                이해할 수 있도록 별도의 연결화면 또는 팝업화면 등을 제공하여 이용자의
                확인을 구하여야 합니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;은 「전자상거래 등에서의 소비자보호에 관한 법률」,
          ...
          <Section title="제4조 (서비스의 제공 및 변경)">
            <ol className="list-none space-y-2">
              ...
              <Li n="3">
                &ldquo;몰&rdquo;이 제공하기로 이용자와 계약을 체결한 서비스의 내용을
                재화등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그
                사유를 이용자에게 통지 가능한 주소로 즉시 통지합니다.
              </Li>
              <Li n="4">
                전항의 경우 &ldquo;몰&rdquo;은 이로 인하여 이용자가 입은 손해를
                배상합니다. 다만, &ldquo;몰&rdquo;이 고의 또는 과실이 없음을 입증하는
                경우에는 그러하지 아니합니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제5조 (서비스의 중단)">
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                ...
                &ldquo;몰&rdquo;이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
                아니합니다.
              </Li>
              <Li n="3">
                사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할
                수 없게 되는 경우에는 &ldquo;몰&rdquo;은 제8조에 정한 방법으로 이용자에게
                통지하고 당초 &ldquo;몰&rdquo;에서 제시한 조건에 따라 소비자에게
                보상합니다. 다만, &ldquo;몰&rdquo;이 보상기준 등을 고지하지 아니한
                경우에는 이용자들의 마일리지 또는 적립금 등을 &ldquo;몰&rdquo;에서
                통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제6조 (회원가입)">
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                &ldquo;몰&rdquo;은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중
                다음 각 호에 해당하지 않는 한 회원으로 등록합니다.
                <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1 text-warm-600">
                  <li>
                    가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한
                    적이 있는 경우. 다만 제7조제3항에 의한 회원자격 상실 후 3년이 경과한
                    자로서 &ldquo;몰&rdquo;의 회원재가입 승낙을 얻은 경우에는 예외로
                    한다.
                  </li>
                  <li>등록 내용에 허위, 기재누락, 오기가 있는 경우</li>
                  <li>
                    기타 회원으로 등록하는 것이 &ldquo;몰&rdquo;의 기술상 현저히 지장이
                    있다고 판단되는 경우
                  </li>
                </ul>
              </Li>
              <Li n="3">
                회원가입계약의 성립 시기는 &ldquo;몰&rdquo;의 승낙이 회원에게 도달한
                시점으로 합니다.
              </Li>
              <Li n="4">
                회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간 이내에
                &ldquo;몰&rdquo;에 대하여 회원정보 수정 등의 방법으로 그 변경사항을
                알려야 합니다.
              </Li>
            </ol>
          </Section>
            ...
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                ...
                <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1 text-warm-600">
                  ...
                  <li>
                    &ldquo;몰&rdquo;을 이용하여 구입한 재화 등의 대금, 기타
                    &ldquo;몰&rdquo; 이용에 관련하여 회원이 부담하는 채무를 기일에
                    지급하지 않는 경우
                  </li>
                  <li>
                    다른 사람의 &ldquo;몰&rdquo; 이용을 방해하거나 그 정보를 도용하는 등
                    전자상거래 질서를 위협하는 경우
                  </li>
                  <li>
                    &ldquo;몰&rdquo;을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에
                    반하는 행위를 하는 경우
                  </li>
                </ul>
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;이 회원 자격을 제한·정지 시킨 후, 동일한 행위가 2회 이상
                반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 &ldquo;몰&rdquo;은
                회원자격을 상실시킬 수 있습니다.
              </Li>
              <Li n="4">
                &ldquo;몰&rdquo;이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다.
                이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의
          ...
          <Section title="제9조 (구매신청 및 개인정보 제공 동의 등)">
            <ol className="list-none space-y-2">
              <Li n="1">
                ...
                방법에 의하여 구매를 신청하며, &ldquo;몰&rdquo;은 이용자가 구매신청을
                함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.
                <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1 text-warm-600">
                  <li>재화 등의 검색 및 선택</li>
                  <li>
                    받는 사람의 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호)
                    등의 입력
                  </li>
                  <li>
                  ...
                  <li>
                    이 약관에 동의하고 위 사항을 확인하거나 거부하는 표시(예, 마우스
                    클릭)
                  </li>
                  <li>
                    재화등의 구매신청 및 이에 관한 확인 또는 &ldquo;몰&rdquo;의 확인에
                    대한 동의
                  </li>
                  <li>결제방법의 선택</li>
                </ul>
              ...
              <Li n="2">
                &ldquo;몰&rdquo;이 제3자에게 구매자 개인정보를 제공할 필요가 있는 경우
                개인정보를 제공받는 자, 개인정보 이용목적, 제공하는 개인정보의 항목,
                개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를
                위탁하는 경우에는 개인정보 취급위탁을 받는 자, 개인정보 취급위탁을 하는
                업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. 다만,
              ...
              <Li n="4">
                &ldquo;몰&rdquo;이 호스팅을 변경하여 이전 할 경우 1년 동안 로그인하지
                않은 휴면회원을 포함한 모든 &ldquo;이용자&rdquo;의 정보를 호스팅사에서
                제공받아 이전하는 호스팅사에 고객의 정보를 등록하고 &ldquo;몰&rdquo;의
                서비스 연속성 관리를 위한 용도로 사용할 수 있습니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제10조 (계약의 성립)">
            <ol className="list-none space-y-2">
              <Li n="1">
                &ldquo;몰&rdquo;은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면
                ...
                <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1 text-warm-600">
                  ...
                  <li>
                    기타 구매신청에 승낙하는 것이 &ldquo;몰&rdquo; 기술상 현저히 지장이
                    있다고 판단하는 경우
                  </li>
                </ul>
              </Li>
              <Li n="2">
                &ldquo;몰&rdquo;의 승낙이 제12조제1항의 수신확인통지형태로 이용자에게
                도달한 시점에 계약이 성립한 것으로 봅니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및
          ...
          <Section title="제11조 (지급방법)">
            <p>
              &ldquo;몰&rdquo;에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각
              호의 방법 중 가용한 방법으로 할 수 있습니다. 단, &ldquo;몰&rdquo;은
            ...
            <ul className="list-disc list-outside ml-5 mt-3 space-y-1 text-warm-600">
              ...
              <li>수령 시 대금지급</li>
              <li>
                마일리지 등 &ldquo;몰&rdquo;이 지급한 포인트에 의한 결제
              </li>
              <li>
                &ldquo;몰&rdquo;과 계약을 맺었거나 &ldquo;몰&rdquo;이 인정한 상품권에
                의한 결제
              </li>
          ...
          <Section title="제12조 (수신확인통지·구매신청 변경 및 취소)">
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                ...
                &ldquo;몰&rdquo;은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그
                요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제15조의
                청약철회 등에 관한 규정에 따릅니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제13조 (재화 등의 공급)">
            <ol className="list-none space-y-2">
              <Li n="1">
                &ldquo;몰&rdquo;은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이
                없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수
                있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만,
                &ldquo;몰&rdquo;이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는
                대금의 전부 또는 일부를 받은 날부터 3영업일 이내에 조치를 취합니다.
              </Li>
              <Li n="2">
                &ldquo;몰&rdquo;은 이용자가 구매한 재화에 대해 배송수단, 수단별
                배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 &ldquo;몰&rdquo;이
                약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야
                합니다. 다만 &ldquo;몰&rdquo;이 고의·과실이 없음을 입증한 경우에는
                그러하지 아니합니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제15조 (청약철회 등)">
            <ol className="list-none space-y-2">
              <Li n="1">
                &ldquo;몰&rdquo;과 재화등의 구매에 관한 계약을 체결한 이용자는
                「전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2항에 따른
                계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게
                이루어진 경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을
                말합니다)부터 7일 이내에는 청약의 철회를 할 수 있습니다.
              </Li>
              <Li n="2">
                이용자는 재화 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는
                반품 및 교환을 할 수 없습니다.
                <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1 text-warm-600">
                  <li>
              ...
              <Li n="3">
                제2항제2호 내지 제4호의 경우에 &ldquo;몰&rdquo;이 사전에 청약철회 등이
          ...
          <Section title="제16조 (청약철회 등의 효과)">
            <ol className="list-none space-y-2">
              <Li n="1">
                ...
                이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 &ldquo;몰&rdquo;이
                이용자에게 재화등의 환급을 지연한때에는 그 지연기간에 대하여 「전자상거래
                등에서의 소비자보호에 관한 법률 시행령」제21조의2에서 정하는 지연이자율을
                곱하여 산정한 지연이자를 지급합니다.
              </Li>
              <Li n="2">
                &ldquo;몰&rdquo;은 위 대금을 환급함에 있어서 이용자가 신용카드 또는
                전자화폐 등의 결제수단으로 재화 등의 대금을 지급한 때에는 지체 없이 당해
                결제수단을 제공한 사업자로 하여금 재화 등의 대금의 청구를 정지 또는
                취소하도록 요청합니다.
              </Li>
              <Li n="3">
                청약철회 등의 경우 공급받은 재화 등의 반환에 필요한 비용은 이용자가
                부담합니다. &ldquo;몰&rdquo;은 이용자에게 청약철회 등을 이유로 위약금
                또는 손해배상을 청구하지 않습니다. 다만 재화 등의 내용이 표시·광고 내용과
                다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 재화 등의
                반환에 필요한 비용은 &ldquo;몰&rdquo;이 부담합니다.
              </Li>
              <Li n="4">
                이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 &ldquo;몰&rdquo;은
          ...
          <Section title="제17조 (개인정보보호)">
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                &ldquo;몰&rdquo;은 회원가입시 구매계약이행에 필요한 정보를 미리 수집하지
                않습니다. 다만, 관련 법령상 의무이행을 위하여 구매계약 이전에 본인확인이
                필요한 경우로서 최소한의 특정 개인정보를 수집하는 경우에는 그러하지
                아니합니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;은 이용자의 개인정보를 수집·이용하는 때에는 당해
                이용자에게 그 목적을 고지하고 동의를 받습니다.
              </Li>
              <Li n="4">
                &ldquo;몰&rdquo;은 수집된 개인정보를 목적외의 용도로 이용할 수 없으며,
                새로운 이용목적이 발생한 경우 또는 제3자에게 제공하는 경우에는
                이용·제공단계에서 당해 이용자에게 그 목적을 고지하고 동의를 받습니다.
                다만, 관련 법령에 달리 정함이 있는 경우에는 예외로 합니다.
              </Li>
              <Li n="5">
                이용자는 언제든지 &ldquo;몰&rdquo;이 가지고 있는 자신의 개인정보에 대해
                열람 및 오류정정을 요구할 수 있으며 &ldquo;몰&rdquo;은 이에 대해 지체 없이
                필요한 조치를 취할 의무를 집니다.
              </Li>
              <Li n="6">
                &ldquo;몰&rdquo;은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는
                자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의
          ...
          <Section title="제18조 (&ldquo;몰&rdquo;의 의무)">
            <ol className="list-none space-y-2">
              <Li n="1">
                ...
                하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화·용역을
                제공하는데 최선을 다하여야 합니다.
              </Li>
              <Li n="2">
                &ldquo;몰&rdquo;은 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록
                이용자의 개인정보(신용정보 포함) 보호를 위한 보안 시스템을 갖추어야
                합니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;이 상품이나 용역에 대하여 「표시·광고의 공정화에 관한
                법률」 제3조 소정의 부당한 표시·광고행위를 함으로써 이용자가 손해를 입은
                때에는 이를 배상할 책임을 집니다.
              </Li>
              <Li n="4">
                &ldquo;몰&rdquo;은 이용자가 원하지 않는 영리목적의 광고성 전자우편을
                발송하지 않습니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제19조 (회원의 ID 및 비밀번호에 대한 의무)">
            <ol className="list-none space-y-2">
              ...
              <Li n="3">
                ...
                인지한 경우에는 바로 &ldquo;몰&rdquo;에 통보하고 &ldquo;몰&rdquo;의
          ...
          <Section title="제20조 (이용자의 의무)">
            ...
            <ul className="list-disc list-outside ml-5 mt-3 space-y-1 text-warm-600">
              ...
              <li>
                &ldquo;몰&rdquo;이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신
                또는 게시
              </li>
              <li>
                &ldquo;몰&rdquo; 기타 제3자의 저작권 등 지적재산권에 대한 침해
              </li>
              <li>
                &ldquo;몰&rdquo; 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
              </li>
              <li>
          ...
          <Section title="제21조 (연결&ldquo;몰&rdquo;과 피연결&ldquo;몰&rdquo; 간의 관계)">
            <ol className="list-none space-y-2">
              <Li n="1">
                상위 &ldquo;몰&rdquo;과 하위 &ldquo;몰&rdquo;이 하이퍼링크 방식 등으로
                연결된 경우, 전자를 연결 &ldquo;몰&rdquo;(웹 사이트)이라고 하고 후자를
                피연결 &ldquo;몰&rdquo;(웹사이트)이라고 합니다.
              </Li>
              <Li n="2">
                연결&ldquo;몰&rdquo;은 피연결&ldquo;몰&rdquo;이 독자적으로 제공하는 재화
                등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을 지지 않는다는 뜻을
                연결&ldquo;몰&rdquo;의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한
          ...
          <Section title="제22조 (저작권의 귀속 및 이용제한)">
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                ...
                지적재산권이 귀속된 정보를 &ldquo;몰&rdquo;의 사전 승낙 없이 복제, 송신,
                출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게
                이용하게 하여서는 안됩니다.
              </Li>
              <Li n="3">
                이용자가 직접 작성 및 등록한 평가점수, 리뷰, 답글, 사진 등의
                게시물(이용자 콘텐츠)에 대한 저작권 및 지적 재산권은 해당 이용자에게
                있으며, 이용자는 &ldquo;몰&rdquo;에 해당 이용자 콘텐츠를 무상으로 이용할
                수 있는 권리를 부여합니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제23조 (분쟁해결)">
            <ol className="list-none space-y-2">
              ...
              <Li n="2">
                &ldquo;몰&rdquo;은 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그
                사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그
                사유와 처리일정을 즉시 통보해 드립니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;과 이용자 간에 발생한 전자상거래 분쟁과 관련하여
          ...
          <Section title="제24조 (적립금 제도)">
            <ol className="list-none space-y-2">
              <Li n="1">
                &ldquo;몰&rdquo;은 &ldquo;몰&rdquo;의 정책에 따라 적립금, 쿠폰(이하
                &lsquo;적립금 등&rsquo;이라 함) 제도를 운영합니다.
              </Li>
              <Li n="2">
                &ldquo;몰&rdquo;은 재화 등의 구매, 이벤트 등 정책에 따라 회원에게
                적립금 또는 쿠폰을 지급할 수 있습니다.
              </Li>
              <Li n="3">
                &ldquo;몰&rdquo;은 구입한 재화 등의 주문취소, 반품의 경우 혹은 회원의
                요청 등에 따라 환불 대금을 적립금으로 지급할 수 있습니다.
              </Li>
              <Li n="4">
                회원은 재화 등을 구매 시 단독으로 또는 다른 결제수단과 결합하여
                &lsquo;적립금 등&rsquo;을 현금과 동일하게 사용할 수 있으나,
                &ldquo;몰&rdquo;이 사전에 사용이 불가능하다고 고지한 경우에는 이를 사용할
                수 없습니다.
              </Li>
              <Li n="5">
                다음 각 호의 경우 &lsquo;적립금 등&rsquo;은 소멸됩니다.
                <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1 text-warm-600">
                  <li>&ldquo;몰&rdquo;을 탈퇴한 경우</li>
                  <li>
                    &ldquo;몰&rdquo;의 정책에 따라 적립금 및 쿠폰의 사용가능 조건 및
                    소멸에 대한 기준이 도래한 경우
                  </li>
                </ul>
              </Li>
              <Li n="6">
                회원은 &lsquo;적립금 등&rsquo;을 타인에게 매매 또는 양도할 수 없고, 이를
                부정하게 취득한 경우 &ldquo;몰&rdquo;의 권한으로 &lsquo;적립금 등&rsquo;을
                회수할 수 있습니다.
              </Li>
            </ol>
          </Section>
          ...
          <Section title="제25조 (재판권 및 준거법)">
            <ol className="list-none space-y-2">
              <Li n="1">
                &ldquo;몰&rdquo;과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소
                당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를 관할하는
                지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가
...
function Li({ n, children }: { n: string | number; children: React.ReactNode }) {
  return (
    <li className="flex gap-2">
      <span className="text-warm-400 shrink-0">{'\u2776\u2777\u2778\u2779\u277A\u277B\u277C\u277D\u277E'[Number(n) - 1] || `${n}.`}</span>
      <span>{children}</span>
    </li>
  );
}
